...
#define GW_MAIN_WINDOW_STATE_KEY "Window/mainWindowState"
    ...
    {
        QString aboutText =
            QString("<p><b>") + qAppName() + QString(" ") + qApp->applicationVersion() + QString("</b></p>") + tr("<p>Copyright &copy; 2014-2021 wereturtle</b>"
    ...
    void MainWindow::buildMenuBar()
    {
        ...
        QAction *showSidebarTabAction = viewMenu->addAction(
            tr("&Outline"),
            this,
            [this]()
            {
        ...
        showSidebarTabAction = viewMenu->addAction(
            tr("&Cheat Sheet"),
            this,
            [this]()
            {
    ...
    void MainWindow::buildStatusBar()
    {
        ...
        midLayout->addWidget(dictionaryIndicator, 0, Qt::AlignRight);
